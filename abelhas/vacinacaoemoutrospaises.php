 ...
 <div class="container">
    <div class="row">
      <aside class="col-xl-6 col-md-6 col-sm-12">
        <img src="images/isolamento.jpg" class=" img-fluid " alt="foto" /></aside>
        <aside class="col-xl-6 col-md-6 col-sm-12">
        <img src="images/isolamento.jpg" class=" img-fluid " alt="foto" /></aside>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <p class="col-xl-6 col-md-6 col-sm-12">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
