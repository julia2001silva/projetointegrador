...
<article>
           ...
           <br>
                ...
                <div class="container">
                <div class="row">
                  <aside class="col-xl-2 col-md-2 col-sm-12">
                    <img src="images/variola.jpg" class="img-fluid " alt="peste negra" />
                    </aside>
                    <p class="col-xl-10 col-md-10 col-sm-12" >Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                         Ut enim ad minim veniam, quis nostrud exercício ullamco laboris nisi
                          ut aliquip ex ea commodo consequat. velit esse cillum dolore eu fugiat 
                          nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in
               ...
               <br>
                  ...
                  <br>
                    ...
                    <br>
                      ...
                      <div class="container">
                        <div class="row">
                          <aside class="col-xl-6 col-md-6 col-sm-12">
                             <img src="images/variola.jpg" class=" img-fluid " alt="peste negra" />
                             </aside>
                             <aside class="col-xl-6 col-md-6 col-sm-12" >
                             <img src="images/variola.jpg" class=" img-fluid " alt="peste negra" />
