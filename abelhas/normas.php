...
<body>
   <div class="container-fluid">
    ...
    <article>
        ...
        <div class="container">
            <div class="row">
                <p class="h5">Aceitação dos termos e condição de uso</p>
        ...
        <div class="container">
            <div class="row">
                <p class="h5">Resgistros e dados pessoais</p>
        ...
        <div class="container">
            <div class="row">
                <p class="h5">Regras de conduta do úsuario</p>
        ...
        <div class="container">
            <div class="row">
                <p class="h5">Denuncia de abusos e violação</p>
