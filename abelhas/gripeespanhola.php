            ...
            <div class="container">
                <div class="row">
                  <header class="col-xl-12 col-md-12 col-sm-12">
                    <p class="h5">GRIPE ESPANHOLA</p>
                
                    <p class="col-xl-12 col-md-12 col-sm-122">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                  ...
                  <div class="container">
                    <div class="row">
                      <aside class="col-xl-2 col-md-3 col-sm-12">
                        <img src="images/colera.jpg" class=" img-fluid " alt="peste negra" />
                      </aside>
                        <p class="col-xl-12 col-md-9 col-sm-12 " >Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                            sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                             Ut enim ad minim veniam, quis nostrud exercício ullamco laboris nisi
                              ut aliquip ex ea commodo consequat. velit esse cillum dolore eu fugiat 
                              nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in
